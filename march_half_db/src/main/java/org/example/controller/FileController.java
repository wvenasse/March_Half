...
public class FileController {
    ...
    public FileResult upload(@RequestParam("picture") MultipartFile picture, HttpServletRequest request) {
        ...
        //获取文件在服务器的储存位置
        String path = "D://WSH//2021//March_Half//march_half_db//src//main//resources//static//uploadImg";
...
// UUIDUtils.getUUID32() +
    ...
    public void getFeedBackPicture(HttpServletResponse response, @PathVariable("photopath")String photopath) throws Exception{
        String realPath="D://WSH//2021//March_Half//march_half_db//src//main//resources//static//uploadImg/"+photopath;
